...
-- Volcando datos para la tabla lhizki.centro_educativo: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla lhizki.ciclo_formativo: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla lhizki.juego: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla lhizki.pregunta: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla lhizki.profesor: ~1 rows (aproximadamente)
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `apellidos`, `email`, `password`, `id_rol`, `id_centro`, `id_ciclo`, `puntos_totales`, `fecha_registro`, `activo`, `ultimo_acceso`) VALUES
	(1, 'Ane', 'Etxeberria López', 'ane.etxeberria@example.com', '12345', 1, 1, 1, 0, '2025-11-05 09:38:14', 1, '2025-11-05 09:38:14'),
