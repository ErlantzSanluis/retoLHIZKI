...
<div class="container bg-gradient-purple text-purple p-4 rounded-3 ">
    ...
    <form action="">
        ...
        <div class="mb-3">
            <label for="seleccionarCentro" class="form-label">Seleccionar Centro</label>
        ...
        <div class="mb-3">
            <label for="seleccionarCiclo" class="form-label">Seleccionar Ciclo</label>
        ...
        <table class="table   bg-gradient-blue text-white">
            <thead class="bg-gradient-blue text-blue">
                <tr>
                    ...
                    <th scope="col">Centro Asignado</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editUserForm">
          ...
          <div class="mb-3">
            <label for="editUserCentro" class="form-label">Centro Asignado</label>
            <input type="text" class="form-control" id="editUserCentro">
          </div>
          <div class="mb-3">
            <label for="editUserCiclo" class="form-label">Ciclo</label>
            <input type="text" class="form-control" id="editUserCiclo">
          </div>
          <div class="mb-3">
            <label for="editUserPuntos" class="form-label">Puntos totales</label>
